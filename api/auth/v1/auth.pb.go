...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x18proto/auth/v1/auth.proto\x12\aauth.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"\x96\x01\n" +
	...
	"\ttenant_id\x18\x03 \x01(\tR\btenantId\"G\n" +
	"\x13HealthCheckResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion2\xb1\t\n" +
	"\vAuthService\x12\x87\x01\n" +
	"\x17AuthenticateCredentials\x12'.auth.v1.AuthenticateCredentialsRequest\x1a(.auth.v1.AuthenticateCredentialsResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/login\x12r\n" +
	"\x0fValidateSession\x12\x1f.auth.v1.ValidateSessionRequest\x1a .auth.v1.ValidateSessionResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/auth/validate\x12n\n" +
	"\x0eRefreshSession\x12\x1e.auth.v1.RefreshSessionRequest\x1a\x1f.auth.v1.RefreshSessionResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/auth/refresh\x12j\n" +
	"\rRevokeSession\x12\x1d.auth.v1.RevokeSessionRequest\x1a\x1e.auth.v1.RevokeSessionResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/auth/revoke\x12y\n" +
	"\x11ProvisionIdentity\x12!.auth.v1.ProvisionIdentityRequest\x1a\".auth.v1.ProvisionIdentityResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/auth/provision\x12{\n" +
	"\x11UpdateCredentials\x12!.auth.v1.UpdateCredentialsRequest\x1a\".auth.v1.UpdateCredentialsResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/auth/credentials\x12c\n" +
	"\vAssignRoles\x12\x1b.auth.v1.AssignRolesRequest\x1a\x1c.auth.v1.AssignRolesResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/roles\x12}\n" +
	"\x12VerifyMFAChallenge\x12\".auth.v1.VerifyMFAChallengeRequest\x1a#.auth.v1.VerifyMFAChallengeResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/auth/mfa/verify\x12\x94\x01\n" +
	"\x17GetEffectivePermissions\x12'.auth.v1.GetEffectivePermissionsRequest\x1a(.auth.v1.GetEffectivePermissionsResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/auth/permissions/{user_id}\x12U\n" +
	"\vHealthCheck\x12\x16.google.protobuf.Empty\x1a\x1c.auth.v1.HealthCheckResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/healthzB6Z4github.com/deloitte-us-consulting/his-be/api/auth/v1b\x06proto3"
...
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	...
	21, // 14: auth.v1.AuthService.HealthCheck:input_type -> google.protobuf.Empty
	1,  // 15: auth.v1.AuthService.AuthenticateCredentials:output_type -> auth.v1.AuthenticateCredentialsResponse
	3,  // 16: auth.v1.AuthService.ValidateSession:output_type -> auth.v1.ValidateSessionResponse
	5,  // 17: auth.v1.AuthService.RefreshSession:output_type -> auth.v1.RefreshSessionResponse
	7,  // 18: auth.v1.AuthService.RevokeSession:output_type -> auth.v1.RevokeSessionResponse
	9,  // 19: auth.v1.AuthService.ProvisionIdentity:output_type -> auth.v1.ProvisionIdentityResponse
	11, // 20: auth.v1.AuthService.UpdateCredentials:output_type -> auth.v1.UpdateCredentialsResponse
	13, // 21: auth.v1.AuthService.AssignRoles:output_type -> auth.v1.AssignRolesResponse
	15, // 22: auth.v1.AuthService.VerifyMFAChallenge:output_type -> auth.v1.VerifyMFAChallengeResponse
	17, // 23: auth.v1.AuthService.GetEffectivePermissions:output_type -> auth.v1.GetEffectivePermissionsResponse
	20, // 24: auth.v1.AuthService.HealthCheck:output_type -> auth.v1.HealthCheckResponse
